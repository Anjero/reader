...
import net.anjero.reader.core.spring.controller.BaseController;
import net.anjero.reader.module.system.security.pojo.SecurityAdmin;
import net.anjero.reader.module.system.security.pojo.SecurityRole;
import net.anjero.reader.module.system.security.service.AdminService;
import net.anjero.reader.module.system.security.service.RoleService;
...
public class AdminController extends BaseController {
  ...
  public String list(Model model, String username, Integer userStatus, @RequestParam(required = false, defaultValue = "1") Integer pageNo) {
    Page<SecurityAdmin> page = adminService.selectAll(username, userStatus, pageNo);
